...
int Onnx2Ncnn::convert(const char* onnxPath, const char* saveNCNNParam, const char* saveNCNNBin) {

    const char* onnxpb = onnxPath;
    const char* ncnn_prototxt = saveNCNNParam;
    const char* ncnn_modelbin = saveNCNNBin;
